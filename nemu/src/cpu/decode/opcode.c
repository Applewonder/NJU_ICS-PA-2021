...
instr_func group_3_b_entry[8] =
    {test_i2rm_b, not_rm_b, inv, mul_rm2a_b, imul_rm2a_b, div_rm2a_b, idiv_rm2a_b};
...
instr_func group_5_indirect_entry[8] =
    {inc_rm_v, dec_rm_v, __ref_call_near_indirect, inv, jmp_near_indirect, inv, __ref_push_rm_v, inv};
...
// add_r2rm_b, add_r2rm_v, add_rm2r_b, add_rm2r_v,
