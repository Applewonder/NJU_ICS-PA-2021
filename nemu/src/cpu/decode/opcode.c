...
instr_func opcode_entry[256] = {
    ...
    /* 0x90 - 0x93*/ __ref_nop, inv, inv, inv,
...
instr_func group_1_b_entry[8] =
    {__ref_add_i2rm_b, or_i2rm_b, adc_i2rm_b, sbb_i2rm_b, and_i2rm_b, sub_i2rm_b, __ref_xor_i2rm_b, __ref_cmp_i2rm_b};
...
instr_func group_1_bv_entry[8] =
    {add_i2rm_bv, or_i2rm_bv, adc_i2rm_bv, __ref_sbb_i2rm_bv, __ref_and_i2rm_bv, __ref_sub_i2rm_bv, __ref_xor_i2rm_bv, __ref_cmp_i2rm_bv};
...
instr_func group_3_b_entry[8] =
    {__ref_test_i2rm_b, __ref_not_rm_b, inv, mul_rm2a_b, imul_rm2a_b, div_rm2a_b, idiv_rm2a_b};
