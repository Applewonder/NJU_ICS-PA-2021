...
void load_sreg(uint8_t sreg)
{
	 ...
	 */
	 cpu.segReg[sreg].base = (cpu.gdtr.base[cpu.segReg[sreg].index].base_31_24 << 24) + (cpu.gdtr.base[cpu.segReg[sreg].index].base_23_16 << 16) + cpu.gdtr.base[cpu.segReg[sreg].index].base_15_0;
